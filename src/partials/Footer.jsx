        ...
        <div className="grid sm:grid-cols-12 gap-8 py-8 md:py-12 border-t border-gray-200">
            ...
            <div className="mb-2">
              ...
              <Link to="/" className="inline-block" aria-label="Cruip">
                ...
                <picture>
                  ...
                  <img className="w-12 md:w-12 lg:w-12" src={WhitePearlLogo} alt="IfItDoesntMatchAnyMedia" />
                </picture>
                </div>
              </Link>
            </div>
          ...
          <div className="sm:col-span-6 md:col-span-3 lg:col-span-2">
            ...
            <ul className="text-sm">
              ...
              <li className="mb-2">
                <Link to="#" className="text-gray-600 hover:text-gray-900 transition duration-150 ease-in-out">Solutions</Link>
              </li>
              <li className="mb-2">
