          ...
          <div className="relative bg-gray-900 rounded py-10 px-8 md:py-16 md:px-12 shadow-2xl overflow-hidden" data-aos="zoom-y-out">
            ...
            <div className="relative flex flex-col lg:flex-row justify-between items-center">
              ...
              <div className="text-center lg:text-left lg:max-w-xl">
                ...
                <p className="text-gray-300 text-lg mb-6">If you have any questions or are interested in partnering with us, feel free to fill out the contact form. We look forward to hearing from you.</p>
                ...
                <form className="w-full lg:w-auto">
                  ...
                  <br></br>
                  <div className="flex flex-col sm:flex-row justify-center max-w-xs mx-auto sm:max-w-md lg:mx-0">
                    <textarea type="text" className="form-input w-full appearance-none bg-gray-800 border border-gray-700 focus:border-gray-600 rounded-sm px-4 py-3 mb-2 sm:mb-0 sm:mr-2 text-white placeholder-gray-500" placeholder="Message" aria-label="Message" />
                  </div>
                  <br></br>
